    ...
    <a href="#" id="navbarUserDropdown" data-toggle="dropdown"
       ...
       class="nav-link dropdown-toggle p-0">
        @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
            <span class="d-inline-flex align-items-center px-3 py-1 bg-white text-dark rounded-pill font-weight-semibold border border-secondary small">
                <img class="rounded-circle mr-2" width="24" height="24"
